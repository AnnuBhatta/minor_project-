    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guardians', models.ManyToManyField(blank=True, related_name='patients', to=settings.AUTH_USER_MODEL)),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'db_table': 'users',
                'indexes': [models.Index(fields=['email'], name='users_email_4b85f2_idx'), models.Index(fields=['phone'], name='users_phone_af6883_idx'), models.Index(fields=['is_guardian'], name='users_is_guar_46d3cd_idx')],
            },
            managers=[
